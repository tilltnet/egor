...
![Overview of Personal Network Template](Qualtrics 1.PNG)

![Alter List Template](Qualtrics 2.PNG)

![Alter Attribute Blocks](Qualtrics 3.PNG)

![Example of alter list name piped into alter attribute questions](Qualtrics 4.PNG)

![Example of Qualtrics code for piped text from alter list](Qualtrics 5.PNG)

![Example of alter pair questions with piped text from alter list](Qualtrics 6.PNG)
