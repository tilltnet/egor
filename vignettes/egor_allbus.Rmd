...
vignette: >
  %\VignetteIndexEntry{egor Allbus}
...
of the original variables, co-varianaces between variables are disregarded. The
...
aquired [here](https://www.gesis.org/en/allbus/allbus-home).***
...
The Allbus variable names are quite technical ranging from V1 to V981, thusly not 
carrying any meaning related to the variable stimulus. Fortunately
...
The code below extracts all variable labels and elimates all non-characters from
